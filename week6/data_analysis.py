...
with open('./life-expectancy.csv') as life_expectancy:
    ...
    for life_expectancy in life_expectancy:
        ...
        # the next set if codes calculate for the maximum and minimum of the entire data
        ...
        # this is for calculating if user selects country
        ...
        # this is for calculating if user selects year
...
if user_input =='Country': 
    print(f'\nThe maximum life expectancy for {country_of_interest} is {max_life_expectancy}')
